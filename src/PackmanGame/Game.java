...
public class Game {
	...
	/**
	 * A constructor that gets array list of box, array list of fruit, array list of packmans
	 *  and array list of ghost and initialize the variables.
	 */
	...
	public static void writeCsv(String filePath,Game Creat) {
		...
		try {
			...
			for(Box b: Boxes) {
				...
				fileWriter.append(",");
				fileWriter.append(String.valueOf(b.p));
				fileWriter.append('\n');
			}
		} catch(Exception ex) {
			ex.printStackTrace();
