...
public class Server {
	...
	/**
	 * This class calculate the statistics of the games for the game we played. 
	 */
	...
	/**
	 * Connect to the server and take from there the first score, the second score and my best score.
	 */ 
